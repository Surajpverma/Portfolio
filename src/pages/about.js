                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8 '>
                        <div className=' col-span-5 flex flex-col items-start justify-start xl:col-span-5 md:order-2 md:col-span-8'> <h2 className='mb-4 text-2xl font-bold uppercase dark:text-primaryDark text-primary heading tracking-widest'>ABOUT ME</h2>
                            <p className='font-medium first-letter:float-left 
                              ...
                              first-letter:text-light dark:first-letter:text-dark first-letter:bg-dark dark:first-letter:bg-light first-letter:px-2 first-letter:font-bold'>Hi, I&apos;m SURAJ PAL, a web developer with a passion for creating beautiful, functional,
                        ...
                        <Image src={hello} alt='meri photu' className='w-1/3 h-auto 2xl:invisible px-8 self-center mt-16 bg-blend-multiply'/>
                        </div>
